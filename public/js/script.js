...
function openPreview(image) {
    preview = `
        <div id="overlay" class="position-fixed w-100 h-100 z-3 d-flex justify-content-center align-items-center" style="background-color: #0008" onclick="closePreview()" data-bs-theme="dark">
